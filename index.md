...
I work on privacy at [DuckDuckGo](https://duckduckgo.com/). I completed my Ph.D. *Cum Laude* at IMDEA Networks Institute in 2025, advised by [Dr. Narseo Vallina-Rodriguez](https://networks.imdea.org/team/imdea-networks-team/people/narseo-vallina-rodriguez/), and was most recently a Postdoctoral Researcher there.

On the research side, my interests span across (1) empirical privacy measurement and auditing of platforms, apps, and AI systems, (2) AI safety — evaluation, moderation, and privacy risks in AI models and web agents, and (3) regulatory compliance. I have published in top peer-reviewed venues (e.g., PETS, IMC, USENIX Security). I received the USENIX Security 2026 Distinguished Paper Award, the USENIX Internet Defense Prize 2026, and the CNIL-Inria Privacy Protection Prize 2026 for exposing covert web-to-app tracking via localhost on Android. <!-- and the Best Poster Award at the TMA'22 Ph.D. school for my novel approach to IoT testing. -->
